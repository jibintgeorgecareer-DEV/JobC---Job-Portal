...
if(isset($_POST["btn_submit"]))
{
 ...
 $insqry="INSERT INTO tbl_soft_skills(soft_skill_name) values('".$name."')";
...
<?php
		if(isset($_GET["clrID"]))//Delete Skills
		{
	$quer="DELETE FROM tbl_soft_skills WHERE soft_skill_id='".$_GET["clrID"]."'";
	if($con->query($quer))
	{
		?>
        <script>
...
<form id="form1" name="form1" method="post" action="">
  <div class="form-container">
    <div class="form-header">
      <i class="fas fa-edit"></i> Add Soft Skills
    </div>
    <div class="form-body">
      <div class="form-group">
        <label for="txt_name2" class="form-label">Skills</label>
...
<table border="1" height="150" class="table">
   ...
   <?php
   $i=0;
   $selqry="select * from tbl_soft_skills ";
   ...
   while($data=$rows->fetch_assoc())
   {
	...
	<tr>
         ...
         <td><?php echo $i ?></td>	 
        <td><?php echo $data['soft_skill_name'] ?></td>
     	 	 
        
        
        <td><a href="SoftSkill.php? clrID=<?php echo $data['soft_skill_id']?>">Delete</a></td>
</tr>
   <?php
   }
   ?>
